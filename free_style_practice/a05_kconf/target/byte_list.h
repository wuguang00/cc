 ...
 * or transfer ("export") laws.  Diversion contrary to U.S. and
 * international law is strictly prohibited.
 *
 * Description:
 *   This header types, function prototypes, litterals, ... that are
 *   necessary to make use of the byte list facilities.
 ****************************************************************************/
