...
*               for DDR3 and DDR4 DIMMs. Also provides the constants to
...
* Included Headers
******************************************************************************/
#include "spd_ddr3_block.h"    // load DDR3 offsets/values
...
//
// SPD EEPROM Field Byte Offsets/IDs Common to DDR3 &  DDR4
//
...
// LRDIMM is different from DDR3 vs DDR4
...
//
// SPD TS Register IDs. All Thermal Sensor is common between DDR3 &  DDR4
//
